...
{
    image[i-1].setAttribute("src","./ASSET/images/Astroids/"+i+".jpg")
...
//this if for header
        ...
        function inc()
        {
            ...
            {
                 indval = 0;
                 document.getElementById("header").style.backgroundImage="url(./ASSET/images/Astroids/"+imagesarr[indval]+")"
            }
            else{
                document.getElementById("header").style.backgroundImage="url(./ASSET/images/Astroids/"+imagesarr[indval]+")"
            }
        ...
        function openImag(pic,name,info)
        {
            ...
            document.getElementById("subWindowImg").src='./ASSET/images/Astroids/'+pic+".jpg"
