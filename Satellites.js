...
{
    image[i-1].setAttribute("src","./ASSET/images/Satellites/"+i+".jpg")
...
//this if for header
        ...
        var indval = 0;
        var imagesarr= ["1.jpg","2.jpg","3.jpg","4.jpg","5.jpg"] 
        ...
        function inc()
        {
            ...
            {
                 indval = 0;
                 document.getElementById("header").style.backgroundImage="url(./ASSET/images/Satellites/"+imagesarr[indval]+")"
            }
            else{
                document.getElementById("header").style.backgroundImage="url(./ASSET/images/Satellites/"+imagesarr[indval]+")"
            }
        ...
        function openImag(pic,name,info)
        {
            ...
            document.getElementById("subWindowImg").src='./ASSET/images/Satellites/'+pic+".jpg"
